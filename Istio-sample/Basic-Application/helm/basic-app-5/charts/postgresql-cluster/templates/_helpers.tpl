...
{{- define  "postgresql-cluster.namespace" -}}
...
{{- define "postgresql-cluster.supersecretname" -}}
{{- if .Values.fullnameOverride }}
{{- .Values.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $name := default .Chart.Name .Values.nameOverride }}
...
{{- .Release.Name | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- printf "%s-%s-super-secret" .Release.Name $name | trunc 63 | trimSuffix "-" }}
{{- end }}
{{- end }}
{{- end }}
...
app.kubernetes.io/namespace: {{ include "postgresql-cluster.namespace" . }}
{{- end }}
